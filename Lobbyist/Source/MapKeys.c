...
//						SetColor(0x01);
            ...
            case 'a' : 
						...
						case 'u' : 
							ES_Event Event1;
						  Event1.EventType = UPDATE_DMC_PAIRING;
							Event1.EventParam = 0x01;
							PostDMC(Event1);
							ES_Event Event2;
						  Event2.EventType = UPDATE_DMC_COLOR;
							Event2.EventParam = 0x01;
							PostDMC(Event2);
							ES_Event Event3;
						  Event3.EventType = UPDATE_DMC;
							PostDMC(Event3);
							printf("Updated DMC Paired \r\n");
						break;
						case 'm' : 
							ES_Event Event4;
						  Event4.EventType = UPDATE_DMC_PAIRING;
							Event4.EventParam = 0x00;
							PostDMC(Event4);
							ES_Event Event5;
						  Event5.EventType = UPDATE_DMC_COLOR;
							Event5.EventParam = 0x01;
							PostDMC(Event5);
							ES_Event Event6;
						  Event6.EventType = UPDATE_DMC;
							PostDMC(Event6);
							printf("Updated DMC Unpaired \r\n");
						break;
        }
