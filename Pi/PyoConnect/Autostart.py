...
def SetupGPIO():
    ...
    GPIO.setup(38, GPIO.OUT) #pin 38 is used to indicate the forward command
    GPIO.setup(40, GPIO.OUT) #pin 40 indicates the backward command
    #Roll
    GPIO.setup(31, GPIO.OUT) #pin 31 
...
# except:
#     pass
# okay decompyling PyoManager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.05.12 09:35:04 UTC
