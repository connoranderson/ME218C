...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "LobbyistSM.h"
// the name of the Init function
#define SERV_1_INIT InitLobbyistSM
// the name of the run function
#define SERV_1_RUN RunLobbyistSM
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostMapKeys, PostLobbyistSM
#endif
#if NUM_DIST_LISTS > 1 
