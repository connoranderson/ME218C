...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "PACSM.h"
// the name of the Init function
#define SERV_2_INIT InitPACSM
// the name of the run function
#define SERV_2_RUN RunPACSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "DCService.h"
// the name of the Init function
#define SERV_3_INIT InitDCService
// the name of the run function
#define SERV_3_RUN RunDCService
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4ButtonPress, Check4InitPairing
...
#define TIMER1_RESP_FUNC PostPACSM
#define TIMER2_RESP_FUNC PostPACSM
#define TIMER3_RESP_FUNC PostPACSM
...
#define TIMER14_RESP_FUNC PostButtonService
...
#define AD_TIMER 13
#define MOTOR_TIMER 12
#define ENCODER_TIMER 11
