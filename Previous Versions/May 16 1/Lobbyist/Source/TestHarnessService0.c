...
static uint8_t Forward = 0x00;
static uint8_t Turning = 0x00;
...
//          }
				...
				PostPACSM(NewEvent);
				printf("Initiate pairing command sent\r\n");
      }
